...
function validacao(){
	...
	var twoWordsRegex = new RegExp(/^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÊÍÏÓÔÕÖÚÇÑ]{2,}(?: [A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÊÍÏÓÔÕÖÚÇÑ'-]+){1,}$/);
//usando uma expressão regular para validação do nome e sobrenome (duas palavras)
